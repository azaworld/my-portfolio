        ...
        <div key={bar.label} className="flex flex-1 flex-col items-center gap-1.5">
          <div className="flex h-20 w-full items-end">
            <div
              ...
              role="img"
              aria-label={`${bar.label}: ${bar.value} blockers cleared`}
            />
          </div>
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-3">
        ...
        <Reveal delay={120}>
          <div className="glass rounded-2xl p-6">
            ...
            <p className="mt-1 text-xs text-muted">Items shipped per week, last 12 weeks</p>
            <div className="mt-6">
        ...
        <Reveal delay={240}>
          <div className="glass rounded-2xl p-6">
            <h3 className="text-sm font-semibold">Blockers cleared this week</h3>
            <p className="mt-1 text-xs text-muted">Most before standup ended ☕</p>
            <div className="mt-4">
