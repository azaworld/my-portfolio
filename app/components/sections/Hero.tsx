    ...
    <div className="flex flex-wrap items-center justify-center gap-2.5">
      {SOCIALS.map((s) => (
        <a
          ...
          aria-label={s.label}
          title={s.label}
          className="group flex h-10 w-10 items-center justify-center rounded-full border transition-all duration-300 hover:-translate-y-1.5 hover:scale-110"
          style={{
            color: s.color,
        ...
        >
          <svg viewBox="0 0 24 24" className="h-[18px] w-[18px] fill-current transition-transform duration-300 group-hover:scale-110" aria-hidden>
            <path d={s.path} />
          </svg>
        </a>
      ))}
      <a
        ...
        aria-label="Email"
        title="Email"
        className="group flex h-10 w-10 items-center justify-center rounded-full border border-amber/40 bg-amber/10 text-amber transition-all duration-300 hover:-translate-y-1.5 hover:scale-110"
      >
        <svg viewBox="0 0 24 24" className="h-[18px] w-[18px] transition-transform duration-300 group-hover:scale-110" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
