...
function GrowthCurve() {
  ...
  return (
    <div ref={ref} className="glass rounded-2xl p-6">
      ...
      <p className="mt-1 text-xs text-muted">Role seniority, 2018 → today</p>
      ...
      <p className="mt-2 text-center text-xs text-muted">
        Freelancer → Engineer → Lead → TPM → <span className="text-amber">Founder</span>
      </p>
    </div>
  );
}
    ...
    <Section id="stats" kicker="career analytics" title={<>By the <span className="text-aurora">Numbers</span></>}>
      ...
      <Reveal delay={200}>
        <div className="glass mt-5 rounded-2xl p-6">
          <h3 className="text-sm font-semibold">Industries shipped into</h3>
