        ...
        <Reveal variant="right">
          <div className="glass rounded-2xl p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li>
                <a href="/sdet" className="flex items-center gap-3 text-muted transition-colors hover:text-cyan">
                  <span aria-hidden>🧪</span> SDET & QA Automation CV — shareable page
                </a>
              </li>
              <li>
                <a href="/resume.pdf" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-muted transition-colors hover:text-cyan">
                  <span aria-hidden>📄</span> Résumé — Sr. QA · SDET (PDF)
                </a>
              </li>
              <li>
                <a href="/cv.pdf" target="_blank" rel="noreferrer" className="flex items-center gap-3 text-muted transition-colors hover:text-cyan">
                  <span aria-hidden>📘</span> CV — TPM · QA Consultant (PDF)
                </a>
              </li>
              <li>
              ...
              <li>
                <a href={profile.azademy} target="_blank" rel="noreferrer" className="flex items-center gap-3 text-muted transition-colors hover:text-cyan">
                  <span aria-hidden>🎓</span> AZADEMY — azademy.vercel.app
                </a>
              </li>
              <li>
