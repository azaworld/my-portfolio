...
export const projects = [
  ...
  },
  {
    ...
    org: "Platformz",
    period: "2024 — Present",
    blurb: "Enterprise pet-brand ecosystem — DTC (fur4.com), dealer portal (dealer.fur4.com), referral portal (refer.fur4.com), GOD ops dashboard, AI ops tower on Magento + React + GraphQL. Full QA: automation (Playwright/TS), manual, security (OWASP ZAP), load & performance (JMeter/k6). 60-day 3P EDI program across Amazon, Walmart, Target, Chewy, eBay & Macy's. CEO/CTO/CFO/CMO & board reporting.",
    tags: ["TPM", "QA Automation", "Manual QA", "Security Testing", "Performance Testing", "Magento", "EDI", "React", "GraphQL"],
  ...
  },
  {
    ...
    org: "Platformz",
    period: "2024 — Present",
    blurb: "Precision skate-guard brand platform — 4-zone interactive product color configurator, DTC, dealer portal, dealer-locator, and referral portals on Magento + React + AWS. Full QA across all portals: automation, manual, security, load & performance testing.",
    tags: ["TPM", "QA Automation", "Manual QA", "Performance Testing", "Magento", "React", "AWS"],
  ...
  },
  {
    ...
    org: "Platformz",
    period: "2024 — Present",
    blurb: "Raw pet food delivery platform — zone-based delivery routing, subscription management, and referral portal. Full QA: automation, manual, security, and performance testing end to end.",
