...
export const journey: JourneyStep[] = [
  ...
  },
  {
    ...
    where: "Intelex via TCS — US client",
...
export const missions: Mission[] = [
  ...
  },
  {
    ...
    role: "Augmented Sr. SQA — Intelex via TCS",
    org: "Intelex via TCS — Remote (US client)",
    short: "TCS / Intelex",
    period: "2024 — 2025",
    start: 2024.0,
    end: 2025.9,
...
export const services = [
  {
    icon: "🎯",
    name: "Technical Project Management & Delivery Leadership",
    tagline: "I turn chaos into shipped products — globally.",
    points: [
      "Fractional TPM / delivery lead — standups, cadence, blocker-clearing, risk registers",
      "Product management — roadmap, prioritization, backlog, and customer-signal strategy",
      "Cross-team coordination for 30+ person orgs: engineering, DevOps, design, QA, marketing",
      "CEO / CTO / CFO / CMO & board of directors reporting — P&L alignment, risk, delivery status",
      "Agile transformation — Scrum, Kanban, flow-based delivery, WIP limits, cycle-time tracking",
    ],
    ideal: "Startups scaling past 10 engineers, or enterprises that need a senior operator who reports to the C-suite.",
    accent: "var(--violet)",
  },
  {
    icon: "🧪",
    name: "Quality Engineering & Test Automation",
    tagline: "Full QA lifecycle — manual through automation to production.",
    points: [
      "Test strategy, planning & release-gate design (risk-based, regression, UAT, smoke)",
      "Playwright + TypeScript end-to-end automation (POM, Docker, CI/CD, AWS)",
      "Cypress automation — parallel runs, Cypress Cloud recording, cross-browser",
      "Manual testing — functional, exploratory, cross-device, accessibility (WCAG)",
      "QA team leadership — build the discipline, hire the team, own the quality bar",
    ],
    ideal: "Products shipping without a safety net — or QA teams that need a senior leader.",
    accent: "var(--cyan)",
  },
  {
    icon: "📱",
    name: "Mobile Testing & App Store QA",
    tagline: "From manual testing through Appium to app store publish.",
    points: [
      "Appium iOS & Android automation — native, hybrid, and cross-platform apps",
      "Full mobile QA lifecycle: manual → automation → production publish (App Store & Google Play)",
      "Cross-device compatibility, Xamarin Test Cloud, AWS Device Farm",
      "Healthcare, FinTech & NEMT app testing at regulated scale (HIPAA, PCI-DSS)",
      "BDD with Cucumber/Gherkin — specs product, QA, and engineering all read the same way",
    ],
    ideal: "Mobile teams shipping to app stores who need QA confidence before every release.",
    accent: "#a78bfa",
  },
  {
    icon: "🔒",
    name: "Security, Performance & Load Testing",
    tagline: "Find the holes and the bottlenecks before users do.",
    points: [
      "Security testing — OWASP ZAP, Burp Suite, Kali Linux, penetration testing, vulnerability assessment",
      "Performance & load testing — k6, JMeter, LoadRunner, Locust (smoke, stress, spike, soak)",
      "Grafana + InfluxDB real-time dashboards and HTML stakeholder reports",
      "GraphQL load testing (k6-graphql-loadtesting), API stress, and spike profiling",
      "Security audit consulting — OWASP Top 10, compliance review, release-gate hardening",
    ],
    ideal: "Teams launching at scale, preparing for audits, or recovering from a production incident.",
    accent: "#f87171",
  },
  {
    icon: "🤖",
    name: "AI Products, Agents & Automation — AZAI Labs",
    tagline: "Build with agents, not headcount.",
    points: [
      "Custom AI agents that automate quality, operations, and business decisions",
      "Agentic workflows wired into your existing stack — from POC to production with monitoring",
      "Machine learning & predictive systems (Python, Jupyter, scikit-learn)",
      "GenAI API integration — LLM endpoints, prompt engineering, RAG pipelines",
      "Augmented AI talent — on-tap AI engineers placed into your team via AZAI Labs",
    ],
    ideal: "Teams that want to automate real work and ship AI products without building an AI team from scratch.",
    accent: "var(--magenta)",
  },
  {
    icon: "🚀",
    name: "Fractional CTO & Startup Advisory",
    tagline: "A CTO-level partner without the full-time cost.",
    points: [
      "Tech-stack decisions, architecture review, and build-vs-buy strategy",
      "Product-market fit → engineering roadmap translation",
      "Team structure design — who to hire, when, and how to scale",
      "Investor-ready tech due diligence, pitch support, and board-level reporting",
      "AI strategy and digital transformation — integrate AI into existing operations",
    ],
    ideal: "Pre-seed to Series A founders who need senior tech judgment without a full-time CTO salary.",
    accent: "#34d399",
  },
  {
    icon: "⚙️",
    name: "DevOps, CI/CD & Cloud Infrastructure",
    tagline: "Ship faster with automated pipelines and infrastructure as code.",
    points: [
      "CI/CD pipelines — GitHub Actions, Jenkins, GitLab CI, Bitbucket Pipelines, AWS CodePipeline",
      "Docker + docker-compose containerized test execution and deployment",
      "AWS infrastructure — EC2, Lambda, SQS, S3, Terraform automation",
      "Chaos engineering, reliability testing, Prometheus + Grafana observability",
      "Incident response & disaster recovery playbooks, on-call best practices",
    ],
    ideal: "Engineering teams that want reliable deploys, fast feedback loops, and production confidence.",
    accent: "#60a5fa",
  },
  {
    icon: "🛒",
    name: "E-commerce, EDI & Enterprise Platforms",
    tagline: "Magento, 3P integrations, and complex multi-portal ecosystems.",
    points: [
      "Magento commerce — multi-currency, multi-language, multi-region (USA, UK, Canada, Europe)",
      "3P EDI integration — Amazon, Walmart, Target, Chewy, eBay, Macy's hybrid programs",
      "API integration: QuickBooks, ShipBob, Mailchimp, Twilio, SendGrid, payment gateways",
      "Government & enterprise systems — OpenCRVS, IPEMIS, CBMS, Sothik (4 govt platforms)",
      "Healthcare platforms — NEMT, insurance workflows (CFC, Tokio Marine Kiln, ANICO)",
    ],
    ideal: "Commerce brands scaling through marketplaces, or enterprises with complex multi-portal QA needs.",
    accent: "var(--amber)",
  },
  {
    icon: "👑",
    name: "Executive Coaching & Career Mentorship",
    tagline: "From where you are to where you want to be — 1:1, global.",
    points: [
      "1:1 executive mentorship for QA leaders, TPMs, SDETs, and aspiring engineering managers",
      "Career roadmap: breaking into remote roles, Big Tech, or the global freelance market",
      "Leadership coaching — how to run teams, report to the C-suite, and own the delivery culture",
      "Freelancing mastery — build a Top Rated Upwork profile (23 jobs, all ★5.0)",
      "Personal branding strategy — position yourself as the obvious hire or thought leader",
    ],
    ideal: "Engineers, QA leads, and TPMs who want to level up — or professionals pivoting into tech leadership.",
    accent: "#fbbf24",
  },
  {
    icon: "🎓",
    name: "Training, Workshops & Corporate Bootcamps",
    tagline: "Practical, hands-on training that sticks — via AZADEMY.",
    points: [
      "Test automation bootcamps — Playwright, Cypress, Appium, k6 (beginner → production)",
      "AI & GenAI workshops — LLMs, agents, prompt engineering, building AI-powered tools",
      "QA leadership & process workshops for engineering teams and QA orgs",
      "Corporate training — CI/CD, DevOps, security testing, and performance engineering",
      "Interview prep coaching — technical interviews, system design, and behavioral rounds",
    ],
    ideal: "Engineering teams that need upskilling, or organizations building a QA culture from scratch.",
    accent: "#818cf8",
  },
  {
    icon: "🎙️",
    name: "Public Speaking, Hosting & Podcasting",
    tagline: "I tell the story, host the stage, and make it land.",
    points: [
      "Keynotes & technical talks — delivery, QA, AI, entrepreneurship, remote work",
      "Podcast hosting & guesting — The AZA Execution Show (azapodcast.com)",
      "Event hosting / MC — tech meetups, summits, launch events, corporate offsites",
      "Panel moderator — bring signal, not noise, to expert conversations",
      "Content creation — YouTube (2 channels), audiobooks (Listen2AZA), social media strategy",
    ],
    ideal: "Conferences, corporate events, and media looking for an engaging, multilingual technical voice.",
    accent: "#fb923c",
  },
  {
    icon: "🔍",
    name: "Hiring Strategy & Technical Interviews",
    tagline: "I find the engineers who can actually do the work.",
    points: [
      "Design the hiring process — job specs, scorecards, interview rubrics",
      "Run live technical screens and interviews (QA, engineering, TPM, SDET roles)",
      "Team-building consulting — structure, culture, and onboarding for distributed teams",
      "Candidate coaching — interview prep, resume review, portfolio strategy (via AZADEMY)",
      "Remote-team playbooks — timezone management, async culture, and performance frameworks",
    ],
    ideal: "Founders and hiring managers who can't afford a bad senior hire — or candidates who need an edge.",
    accent: "#2dd4bf",
  },
];

export const availability = {
  status: "Accepting global engagements",
  note: "Fractional, advisory, consulting, coaching, or project-based — remote, worldwide.",
};
...
export const premium = {
  tagline: "For the few who want a global leader in their corner.",
  intro:
    "A limited number of premium slots each quarter — high-touch, senior, and outcome-obsessed. 16+ combined years of experience across 12 parallel roles, distilled into one engagement. When good isn't enough and you need it shipped right.",
  tiers: [
    {
      icon: "👑",
      name: "1:1 Executive Mentorship",
      price: "Private cohort · monthly",
      points: [
        "Weekly 1:1s — QA leadership, TPM growth, SDET career, or breaking into remote/Big Tech roles",
        "Direct async line between sessions — Slack, WhatsApp, or email",
        "Personalized career roadmap with milestones and accountability",
        "Resume, portfolio & personal-brand review — position you as the obvious hire",
        "Interview simulation — technical screens, system design, behavioral rounds",
      ],
      highlight: true,
    },
    {
      ...
      points: [
        "I embed with your team as fractional TPM / CTO / delivery lead",
        "Own the cadence, clear blockers, report to the board, align P&L",
        "Senior judgment on hiring, architecture, and release strategy",
        "QA & test strategy overhaul — process, automation, release gates",
        "AI strategy consulting — where to automate, what to build, what to buy",
      ],
      highlight: false,
    },
    {
      ...
      price: "Project · fixed scope",
      points: [
        "From idea to a working AI agent / product in weeks, not quarters",
        "Built, tested, and shipped with monitoring and observability",
        "Augmented AI talent placed into your team on tap after launch",
        "Full-stack AI — LLMs, RAG, agentic workflows, prompt engineering",
        "Production-grade: CI/CD, security review, load testing included",
      ],
      highlight: false,
    },
  ],
