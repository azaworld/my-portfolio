...
export const projects = [
  ...
  },
  {
    ...
    period: "2021 — 2022",
    blurb: "QA for OpenCRVS — open-source civil registration infrastructure so every person on the planet is recognised from birth. Cypress + TestRail automation, CI/CD integration, and cross-browser coverage.",
    tags: ["Cypress", "TestRail", "CI/CD", "Civic Tech", "Test Design"],
    link: "https://www.opencrvs.org",
  },
  {
    name: "Sothik — Bangla AI Spell Checker",
    org: "REVE Systems",
    period: "2022 — 2023",
    blurb: "QA Lead for Sothik — an AI-powered Bengali grammar & spell checker. Security testing (OWASP ZAP, Burp Suite), performance testing (JMeter/LoadRunner). Results: performance up 60%, critical defects down 30%.",
    tags: ["QA Lead", "Security Testing", "Performance Testing", "AI/NLP", "JMeter"],
    link: "",
  },
];
